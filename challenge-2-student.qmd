...
#chat gpt suggested i use this line of code so i can render
...
ggplot(data = surveys, mapping = aes(x = weight, y = species_id, fill = species_id)) +
  geom_density_ridges(alpha = 0.7, scale = 1.5) +  # Ridge plots with transparency
  labs(
    title = "Distribution of Weight by Species (Ridge Plot)",
    x = "Weight (g)",  
    y = "Species"  
  ) +
  theme(
    axis.text.x = element_text(angle = 45, hjust = 1),  # Rotating x-axis text for clarity
